...
export const TESTS: TestData[] = [
  // personalColor
  {
    ...
    info: {
      ...
      scoreType: 'MBTI',
      mainImage: '/images/ko/personalColor-intro.png',
      thumbImage: '/images/ko/personalColor-thumb.png',
      lang: 'ko',
    ...
    results: [
      {
        type: 'ESTJ',
        query: 'ESTJ',
        img_src: '/images/ko/ESTJ.png'
      },
      {
        type: 'ESTP',
        query: 'ESTP',
        img_src: '/images/ko/ESTP.png'
      },
      {
        type: 'ESFJ',
        query: 'ESFJ',
        img_src: '/images/ko/ESFJ.png'
      },
      {
        type: 'ESFP',
        query: 'ESFP',
        img_src: '/images/ko/ESFP.png'
      },
      {
        type: 'ENTJ',
        query: 'ENTJ',
        img_src: '/images/ko/ENTJ.png'
      },
      {
        type: 'ENTP',
        query: 'ENTP',
        img_src: '/images/ko/ENTP.png'
      },
      {
        type: 'ENFJ',
        query: 'ENFJ',
        img_src: '/images/ko/ENFJ.png'
      },
      {
        type: 'ENFP',
        query: 'ENFP',
        img_src: '/images/ko/ENFP.png'
      },
      {
        type: 'ISTJ',
        query: 'ISTJ',
        img_src: '/images/ko/ISTJ.png'
      },
      {
        type: 'ISTP',
        query: 'ISTP',
        img_src: '/images/ko/ISTP.png'
      },
      {
        type: 'ISFJ',
        query: 'ISFJ',
        img_src: '/images/ko/ISFJ.png'
      },
      {
        type: 'ISFP',
        query: 'ISFP',
        img_src: '/images/ko/ISFP.png'
      },
      {
        type: 'INTJ',
        query: 'INTJ',
        img_src: '/images/ko/INTJ.png'
      },
      {
        type: 'INTP',
        query: 'INTP',
        img_src: '/images/ko/INTP.png'
      },
      {
        type: 'INFJ',
        query: 'INFJ',
        img_src: '/images/ko/INFJ.png'
      },
      {
        type: 'INFP',
        query: 'INFP',
        img_src: '/images/ko/INFP.png'
      }
    ]
  },
  // personalColorEng
  {
    ...
    info: {
      ...
      scoreType: 'MBTI',
      mainImage: '/images/en/personalColorEng-intro.png',
      thumbImage: '/images/en/personalColorEng-thumb.png',
      lang: 'en',
      category: 'characteristic'
    },
    questions: [
      ...
      },
      {
        ...
        answers: [
          ...
          },
          {
            type: 'I',
            content:
              'Prefer having casual conversations with a small group of friends.'
          }
        ]
      },
      {
      ...
      },
      {
        which: 'TF',
        question:
          "If a friend is sharing their problem but I think it's their fault, I...",
        answers: [
          {
            type: 'T',
          ...
          },
          {
            type: 'F',
            content:
              "Try to be indirect because I'm afraid they'll feel bad if I'm too direct."
          }
        ]
      },
      {
        ...
        answers: [
          ...
          },
          {
            type: 'P',
            content:
              "Often think 'I'll pack tomorrow' but end up forgetting things."
          }
        ]
      },
      {
        which: 'JP',
        question:
          'I planned to study at home, but friends want me to hang out. I...',
        answers: [
          {
            type: 'J',
        ...
        answers: [
          {
            type: 'J',
            content:
              'Following my plan! I like proceeding in order according to a schedule.'
          },
          {
            type: 'P',
            content:
              'Going with the flow! I prefer being flexible and adaptable.'
          }
        ]
      }
    ],
    results: [
      {
        type: 'ESTJ',
        query: 'ESTJ',
        img_src: '/images/en/ESTJ.png'
      },
      {
        type: 'ESTP',
        query: 'ESTP',
        img_src: '/images/en/ESTP.png'
      },
      {
        type: 'ESFJ',
        query: 'ESFJ',
        img_src: '/images/en/ESFJ.png'
      },
      {
        type: 'ESFP',
        query: 'ESFP',
      ...
      },
      {
        type: 'ENTJ',
        query: 'ENTJ',
        img_src: '/images/en/ENTJ.png'
      },
      {
        type: 'ENTP',
        query: 'ENTP',
        img_src: '/images/en/ENTP.png'
      },
      {
        type: 'ENFJ',
        query: 'ENFJ',
        img_src: '/images/en/ENFJ.png'
      },
      {
        type: 'ENFP',
        query: 'ENFP',
        img_src: '/images/en/ENFP.png'
      },
      {
        type: 'ISTJ',
        query: 'ISTJ',
        img_src: '/images/en/ISTJ.png'
      },
      {
        type: 'ISTP',
        query: 'ISTP',
        img_src: '/images/en/ISTP.png'
      },
      {
        type: 'ISFJ',
        query: 'ISFJ',
        img_src: '/images/en/ISFJ.png'
      },
      {
        type: 'ISFP',
        query: 'ISFP',
        img_src: '/images/en/ISFP.png'
      },
      {
        type: 'INTJ',
        query: 'INTJ',
        img_src: '/images/en/INTJ.png'
      },
      {
        type: 'INTP',
        query: 'INTP',
        img_src: '/images/en/INTP.png'
      },
      {
        type: 'INFJ',
        query: 'INFJ',
        img_src: '/images/en/INFJ.png'
      },
      {
        type: 'INFP',
        query: 'INFP',
        img_src: '/images/en/INFP.png'
      }
    ]
  },
  // personalColorJP
  {
    ...
    info: {
      ...
      scoreType: 'MBTI',
      mainImage: '/images/jp/personalColorJP-intro.png',
      thumbImage: '/images/jp/personalColorJP-thumb.png',
      lang: 'jp',
      category: 'characteristic'
    },
    questions: [
      ...
      },
      {
        which: 'TF',
        question:
          '悩みを話す友達の話を聞いていたら、友達に非があるように思える。そんなとき私は？',
        answers: [
          {
            type: 'T',
      ...
      },
      {
        ...
        answers: [
          ...
          },
          {
            type: 'P',
            content:
              '「明日用意しよう」と思いながら、忘れて持っていかないことが多い。'
          }
        ]
      },
      {
        which: 'JP',
        question:
          '終わった後に家で勉強しようと思っていたのに、友達が遊ぼうと誘ってきた。私は？',
        answers: [
          {
            type: 'J',
    ...
    results: [
      {
        type: 'ESTJ',
        query: 'ESTJ',
        img_src: '/images/jp/ESTJ.png'
      },
      {
        type: 'ESTP',
        query: 'ESTP',
        img_src: '/images/jp/ESTP.png'
      },
      {
        type: 'ESFJ',
        query: 'ESFJ',
        img_src: '/images/jp/ESFJ.png'
      },
      {
        type: 'ESFP',
        query: 'ESFP',
        img_src: '/images/jp/ESFP.png'
      },
      {
        type: 'ENTJ',
        query: 'ENTJ',
        img_src: '/images/jp/ENTJ.png'
      },
      {
        type: 'ENTP',
        query: 'ENTP',
        img_src: '/images/jp/ENTP.png'
      },
      {
        type: 'ENFJ',
        query: 'ENFJ',
        img_src: '/images/jp/ENFJ.png'
      },
      {
        type: 'ENFP',
        query: 'ENFP',
        img_src: '/images/jp/ENFP.png'
      },
      {
        type: 'ISTJ',
        query: 'ISTJ',
        img_src: '/images/jp/ISTJ.png'
      },
      {
        type: 'ISTP',
        query: 'ISTP',
        img_src: '/images/jp/ISTP.png'
      },
      {
        type: 'ISFJ',
        query: 'ISFJ',
        img_src: '/images/jp/ISFJ.png'
      },
      {
        type: 'ISFP',
        query: 'ISFP',
        img_src: '/images/jp/ISFP.png'
      },
      {
        type: 'INTJ',
        query: 'INTJ',
        img_src: '/images/jp/INTJ.png'
      },
      {
        type: 'INTP',
        query: 'INTP',
        img_src: '/images/jp/INTP.png'
      },
      {
        type: 'INFJ',
        query: 'INFJ',
        img_src: '/images/jp/INFJ.png'
      },
      {
        type: 'INFP',
        query: 'INFP',
        img_src: '/images/jp/INFP.png'
      }
    ]
  }
]
